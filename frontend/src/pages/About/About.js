    ...
    <div className="about-container">
      ...
      <div className="about-main">
        <p className="about-content">
          ...
          well you are doing. I created this as a personal project, and I have
          ...
          open source project, The code is available on the GitHub -{" "}
          <a href="https://github.com/harshbhatt7585/YogaIntelliJ">
        ...
        <div className="developer-info">
          ...
          <p className="about-content">
            I am Harsh, I am Full Stack Developer, AI Enthusiastic, Content
            Creator, Tutor, I love to work with technology and love to share on
            my youtube channel, I hope this project will help you.
          </p>
          <h4>Contact</h4>
